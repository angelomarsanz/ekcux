				  ...
				  <table class="table table-bordered table-striped table-hover js-basic-example dataTable no-footer">
				      <thead>
				          <tr>
				              ...
				              <th><?php echo e(__('Phonenumber')); ?></th>
				      ...
				      <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
				        <tr>
				          ...
				          <td ><a href="https://wa.me/<?php echo e($user->whatsapp); ?>" target="blank" class="btn btn-sm btn-neutral margin-0"><?php echo e($user->whatsapp); ?></a></td>
