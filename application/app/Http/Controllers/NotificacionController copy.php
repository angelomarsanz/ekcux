...
class NotificacionController extends Controller
{
    ...
    public function index()
    {
        ...
        $notificacionesCreadas = Notificacion::where('user_id', Auth::user()->id)->where('estatus_notificacion', 'Creada');
        ...
        $notificacionesEnviadas = Notificacion::orderByDesc('id')->where('user_id', Auth::user()->id)->limit($limiteEnvio);
    ...
    {
        echo "Notificaciones encontradas";//simplemente haremos que devuelva esto
    }
}
