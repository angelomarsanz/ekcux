...
@section('content')
                        ...
                        <div class="row">
                            <div class="col">
                               ...
                               <ul id="glbreadcrumbs-two">
                                    ...
                                    <li><a href="#" class="a"><strong>2.</strong> {{__('Complete los datos del fondeo')}}.</a></li>
                                    <li><a href="#" class="a"><strong>3.</strong> {{__('Confirme el fondeo')}}.</a></li>
                                </ul>
                            </div>            
    ...
    <div class="col-lg-3 col-md-4 col-sm-12">
            <a href="{{url('/')}}/{{app()->getLocale()}}/agregarFondeo/{{$billetera->id}}">
