<?php 
    ...
    $notificaciones = '';
    if (isset($vectorNotificaciones)):
        $contadorNotificaciones = $vectorNotificaciones['contador'];
        $notificaciones = $vectorNotificaciones['notificaciones'];
    endif;
?>
        ...
        <div class="row clearfix">
            <div class="col-12">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a id="notification-icon" href="javascript:void(0);" class="dropbtn" role="button">
                            <span id="notification-count" style="color:white">
                                <?= $contadorNotificaciones > 0 ? $contadorNotificaciones : '' ?> 
                            </span>
                            <i class="icon-bell"></i>
                        </a>
                    </li>
