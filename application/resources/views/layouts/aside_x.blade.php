            ...
            <div class="col-12">
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="{{ (Route::is('retiros.index') ? 'active open' : '') }}"> 
                            <a href="{{route('retiros.index',  app()->getLocale())}}"><i class="icon-arrow-up"></i><span>
                            {{__('Retiros')}}</span></a>
                        </li> 
                        ...
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block"><i class="icon-bar-chart"></i><span>{{__('Trade')}}</span></a>
                            <ul class="ml-menu">
                                <li><a href="{{route('offerbook',  app()->getLocale())}}" class=" waves-effect waves-block">{{__('Offer Book')}}</a></li>
                                <li><a href="{{route('mybook',  app()->getLocale())}}" class=" waves-effect waves-block">{{__('My Positions')}}</a></li>
                                 <li><a href="{{route('myclosed',  app()->getLocale())}}" class=" waves-effect waves-block">{{__('My Closed Trades')}}</a></li>
                            </ul>
                        </li>
