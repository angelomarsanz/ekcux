    ...
    <div class="row">
        ...
        <div class="col-md-9 ">
          ...
          <div class="card" >
            ...
            <div class="body">
              <form action="{{route('post.guardarPagoRetiro', app()->getLocale())}}" method="post" enctype="multipart/form-data" >
                    {{csrf_field()}}
                    <input type="hidden" value="{{$transaccion->id}}" name="transaccion_id">
                    <input type="hidden" value="{{$retiro->id}}" name="retiro_id">
                    <input type="hidden" value="{{$retiro->contrapartida_id}}" name="fondeo_id">
